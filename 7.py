...
TOKEN = '6822092678:AAF3XmEciCCdHfZKCPuycLnXlPm3MC8Ig6o'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002177282355
CHANNEL_ID = -1002177282355
error_channel_id = -1002177282355
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACEESS:-@Its_fire_cheats*", parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "* FOR RESELLERSHIP DM:-@Its_fire_cheats", parse_mode='Markdown')
